...
#define  PROBE_TERM_OS_CFG_CMD_RX_TASK_STK_SIZE 512         /* OS task stack size.                                  */
#define  PROBE_TERM_OS_CFG_CMD_RX_TASK_PRIO          10         /* OS task priority.                                    */
#define  PROBE_TERM_OS_CFG_CMD_TX_TASK_STK_SIZE     512         /* OS task stack size.                                  */
#define  PROBE_TERM_OS_CFG_CMD_TX_TASK_PRIO          11         /* OS task priority.                                    */
                                                                /* ----------------- TRACE INTERFACE ------------------ */
#define  PROBE_TERM_CFG_TRC_EN                        1         /* Interface enable.                                    */
#define  PROBE_TERM_OS_CFG_TRC_TASK_STK_SIZE        512         /* OS task stack size.                                  */
